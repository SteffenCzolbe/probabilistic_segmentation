...
python3 -m src.train --gpus 1 --model mcdropout --dataset isic18 --num_filters 32 64 128 192 --max_epochs 250 --dropout_prob 0.2 --batch_norm --weight_decay 0 --batch_size 16  --notest --early_stop_patience 50
