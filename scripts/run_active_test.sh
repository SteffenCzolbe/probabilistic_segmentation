...
python3 -m src.active_learning --gpus 1 --model punet --dataset isic18 --num_filters 32 64 128 192 --max_epochs 1 --learning_rate 0.00001 --beta 0.0005 --latent_space_dim 6 --dropout --batch_norm --batch_size 16  --start_with 5 --add 5 --num_iters 1
